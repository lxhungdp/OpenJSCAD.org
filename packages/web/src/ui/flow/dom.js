const makeOutput = ({ sources, extras }) => sources.state
  ...
  .combine((state, i18n) => require('../views/main')(state, i18n, extras.paramsCallbacktoStream, extras.editorCallbackToStream, extras.structureCallbacktoStream || extras.trussCallbacktoStream, extras.viewerUiCallbacktoStream || { callback: null }),
